...
| `docs/team/` | 团队分工总览、组织架构图与个人任务书 | 01-人1-仿真引擎.md、org-chart.svg |
...
| `org-chart.svg` | `docs/team/` | 团队架构图（任务书用） |
...
个人任务书统一放在 `docs/team/` 目录，文件命名为 `0X-人X-角色.md`。
