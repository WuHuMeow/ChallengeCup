...
| 3 | 部署运行说明文档 | docs/operations/deployment.md | IB | 答题要求第 2 条 |
...
| 风险 | 影响 | 应对 |
|------|------|------|
| W1 接口未冻结 | 后续全部 delay | TL 必须在 7/23 前提交 core/types.py + algorithms/base.py |
...
├── docs/
│   ├── architecture/            # 架构与接口说明
│   ├── operations/              # 部署与环境配置
│   ├── reports/                 # 验证与审计报告
│   ├── reference/competition/   # 赛题 PDF
│   ├── team/
